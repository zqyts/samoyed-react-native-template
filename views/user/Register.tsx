...
import { Button, Checkbox, Toast, WhiteSpace, WingBlank } from '@ant-design/react-native'
    ...
    return (
        <View>
            <View style={styles.formWrap}>
                <RNInput name='nickName' control={control} type='phone' errors={errors} placeholder='请输入姓名' />
                <RNInput name='mobile' control={control} type='phone' errors={errors} placeholder='请输入手机号' />
                <RNInput
                    name='validCode'
                    control={control}
                    type='number'
